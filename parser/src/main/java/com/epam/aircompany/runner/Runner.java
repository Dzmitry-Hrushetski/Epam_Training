...
public class Runner {
	...
	public static void webStart(String type) {
		...
		Set<Airplane> findAirplanes=null;
		AirCompany company=null;
		ParserType typeParser = null;
		
		switch(type) {
		case "dom": typeParser=ParserType.DOM;
			break;
		case "sax": typeParser=ParserType.SAX;
			break;
		case "stax": typeParser=ParserType.STAX;
			break;
		}
		...
		try {
			...
			AbstractAirCompanyBuilder builder = AirCompanyBuilder.createAirCompanyBuilder(typeParser);
